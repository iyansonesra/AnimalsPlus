...
var cards: [Card] = [
    ...
    Card(name: "Spider Monkey", cardNumber: "6.2", cardImage: "monkey", cardClass: "Mammalia", cardHeight: "21\"", cardAbout: "Spider monkeys live in the dense forests of Central and South America, swinging from tree to tree using their long arms and prehensile tails. They make their homes high up in the canopy, where they can find plenty of fruits and leaves to eat and stay safe from predators on the forest floor.", cardFun: "\u{2022} Limber Limbs: Spider monkeys are known for their long, slender limbs and prehensile tails, which they use like an extra hand to grab onto branches. \n\n \u{2022}  Troop Tales: They are highly social animals, living in large groups called troops, which can consist of up to 35 individuals. \n\n \u{2022} Monkey Melodies: Spider monkeys have a unique way of communicating with each other through a variety of vocalizations, including barks, whinnies, and screams."),
